...
namespace MSHC.WPF.Controls
{
    ...
    public partial class CircularProgressBar
    {
        ...
        {
            ellipse.SetValue(Canvas.LeftProperty, 50 + (System.Math.Sin(offset + (posOffSet * step)) * 50));
            ellipse.SetValue(Canvas.TopProperty, 50 + (System.Math.Cos(offset + (posOffSet * step)) * 50));
        }
